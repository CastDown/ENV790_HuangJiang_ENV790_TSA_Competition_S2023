...
```{r}
#| warning: false
setwd("/Users/jiangliwei/Documents/GitHub/ENV790_HuangJiang_ENV790_TSA_Competition_S2023")
...
ts_combined <- combined %>% 
  ts(start = c(2005,1), frequency = 365) %>% 
  msts(seasonal.periods = c(7, 365.25/12))
```
