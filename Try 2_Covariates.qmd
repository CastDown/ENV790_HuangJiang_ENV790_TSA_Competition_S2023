...
nn_hum_perf <- forecast(tbats_hum_model, h = 365,
                           xreg = fourier(ts_cov_train[, 1],
                                          h = 365,
                                          K = 7)
                           )
...
humidity_scores <- rbind(sarima_hum_score, stl_hum_score, tbats_hum_score, nn_hum_score)
row.names(humidity_scores) <- c("SARIMA", "STL", "TBATS", "Neural Network")
